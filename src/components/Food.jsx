               ...
               <div className="flex flex-col lg:flex-row justify-between">
                    <div>
                       ...
                       <div className="flex justify-between flex-wrap gap-2">
                         ...
                         <button onClick={()=>filterType("paneer")} className="border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white">Paneer</button>
                         ...
                         <button onClick={()=>filterType("biryani")} className="border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white">Biryani</button>
                         <button onClick={()=>filterType("bread")} className="border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white">Bread</button>
                         <button onClick={()=>filterType("sweets")} className="border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white">Sweets</button>
                       </div>
                    </div>
                    <div>
                       {/**Filter Price */}
